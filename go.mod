...
require (
	...
	github.com/stolostron/backplane-operator v0.0.0-20250828195818-ffaaa2936ae6
	github.com/stolostron/search-v2-operator v0.0.0-20250903194557-3a6c3186237e
