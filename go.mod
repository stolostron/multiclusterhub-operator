...
require (
	...
	github.com/stolostron/backplane-operator v0.0.0-20250903145007-4d24ccd5648d
	github.com/stolostron/search-v2-operator v0.0.0-20250911185801-764b0897c40f
