...
require (
	...
	github.com/stolostron/backplane-operator v0.0.0-20251119165541-efb29e7b0f13
	github.com/stolostron/search-v2-operator v0.0.0-20251121195928-3e2311ca227e
