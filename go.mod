...
require (
	...
	github.com/stolostron/backplane-operator v0.0.0-20260529150050-5fcc5e63f377
	github.com/stolostron/search-v2-operator v0.0.0-20260602195539-7e0a557da7fa
