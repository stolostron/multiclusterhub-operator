...
require (
	...
	github.com/stolostron/backplane-operator v0.0.0-20251020132058-56ce33ea08f6
	github.com/stolostron/search-v2-operator v0.0.0-20251022173352-17538823c720
