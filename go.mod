...
require (
	...
	github.com/stolostron/backplane-operator v0.0.0-20250220181241-a2bc7f1dc5c4
	github.com/stolostron/search-v2-operator v0.0.0-20250224211131-1d8c2580331a
