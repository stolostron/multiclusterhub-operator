...
require (
	...
	github.com/openshift/hive/apis v0.0.0-20220308220811-98f5dfd6f832 // indirect
	github.com/pkg/errors v0.9.1 // indirect
	github.com/prometheus-operator/prometheus-operator/pkg/apis/monitoring v0.54.1 // indirect
