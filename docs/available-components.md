...
| siteconfig | Simplifies deployment of single-node OpenShift (SNO) and multi-node clusters using declarative YAML configurations for far-edge and at-scale deployments. | False |
