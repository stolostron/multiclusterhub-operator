...
//+kubebuilder:rbac:groups="",resources=configmaps;secrets;serviceaccounts;services;persistentvolumeclaims;pods;endpoints,verbs=*
...
//+kubebuilder:rbac:groups=addon.open-cluster-management.io,resources=managedclusteraddons;addondeploymentconfigs;clustermanagementaddons;managedclusteraddons/finalizers;clustermanagementaddons/finalizers;managedclusteraddons/status;clustermanagementaddons/status,verbs=get;list;watch;create;update;delete;patch
...
//+kubebuilder:rbac:groups=rbac.authorization.k8s.io,resources=clusterrolebindings;clusterroles,verbs=*
...
//+kubebuilder:rbac:groups=search.open-cluster-management.io,resources=searches,verbs=create;delete;get;list;patch;update;watch
