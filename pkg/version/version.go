...
var RequiredMCEVersion = "2.11.0"
var RequiredCommunityMCEVersion = "0.9.0"
...
// MCE must match the required major.minor version exactly (same channel).
...
// validPatchVersion checks that "have" matches the major.minor of "required" and has an equal or
// higher patch version. This is stricter than validVersion: it rejects versions where the minor
// version differs from the required version, catching both "ahead" and "behind" channel mismatches.
