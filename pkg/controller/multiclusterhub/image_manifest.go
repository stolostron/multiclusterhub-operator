...
func addBorrowedImageOverrides(io map[string]string) map[string]string {
	...
	if io["origin_oauth_proxy"] == "" {
		// image digest equivalent of `origin-oauth-proxy:4.5`
		io["origin_oauth_proxy"] = "quay.io/openshift/origin-oauth-proxy@sha256:8599745a5bf914a3e00efa08f9ddd2c409de91c551d330b80e683bca52aa2146"
	}
	return io
}
