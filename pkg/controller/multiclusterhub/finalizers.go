...
func (r *ReconcileMultiClusterHub) cleanupHiveConfigs(reqLogger logr.Logger, m *operatorsv11.MultiClusterHub) error {
...
func (r *ReconcileMultiClusterHub) cleanupAPIServices(reqLogger logr.Logger, m *operatorsv11.MultiClusterHub) error {
...
func (r *ReconcileMultiClusterHub) cleanupClusterRoles(reqLogger logr.Logger, m *operatorsv11.MultiClusterHub) error {
...
func (r *ReconcileMultiClusterHub) cleanupClusterRoleBindings(reqLogger logr.Logger, m *operatorsv11.MultiClusterHub) error {
...
func (r *ReconcileMultiClusterHub) cleanupMutatingWebhooks(reqLogger logr.Logger, m *operatorsv11.MultiClusterHub) error {
	err := r.client.DeleteAllOf(
		context.TODO(),
...
func (r *ReconcileMultiClusterHub) cleanupPullSecret(reqLogger logr.Logger, m *operatorsv11.MultiClusterHub) error {
...
func (r *ReconcileMultiClusterHub) cleanupCRDs(log logr.Logger, m *operatorsv11.MultiClusterHub) error {
	err := r.client.DeleteAllOf(
		context.TODO(),
...
func (r *ReconcileMultiClusterHub) cleanupClusterManagers(reqLogger logr.Logger, m *operatorsv11.MultiClusterHub) error {
