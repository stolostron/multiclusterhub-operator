...
_chart_names=["application-chart", "cert-manager", "cert-manager-webhook", "cluster-lifecycle", "configmap-watcher", "console-chart", "insights-chart", "discovery-operator", "grc", "kui-web-terminal", "management-ingress", "search-prod"]
