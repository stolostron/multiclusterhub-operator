...
_chart_names=["application-chart", "assisted-service", "cluster-lifecycle", "console-chart", "insights-chart", "discovery-operator", "grc", "kui-web-terminal", "management-ingress", "search-prod"]
