...
import (
	...
	"github.com/stolostron/multiclusterhub-operator/test/function_tests/utils"
	"k8s.io/apimachinery/pkg/api/errors"
	"k8s.io/apimachinery/pkg/apis/meta/v1/unstructured"
)

var testMCHFeatures = func() func() {
	return func() {
...
var testSanityChecks = func() func() {
	return func() {
		It("Installing MCH with bad image reference - should have Installing status", func() {
		...
		It("Installing MCH with old rcm component on cluster", func() {
			By("Installing old component")
			subName := "rcm-sub"
			sub := &unstructured.Unstructured{
				Object: map[string]interface{}{
...
var testManagedCluster = func() func() {
	return func() {
