...
func NewMultiClusterHub(name, namespace, imageOverridesConfigmapName string, disableHubSelfManagement bool) *unstructured.Unstructured {
	...
	annotations := map[string]interface{}{
		"installer.open-cluster-management.io/mce-subscription-spec": `{"channel": "stable-2.5","installPlanApproval": "Automatic","name": "multicluster-engine","source": "multiclusterengine-catalog","sourceNamespace": "openshift-marketplace"}`,
	}
