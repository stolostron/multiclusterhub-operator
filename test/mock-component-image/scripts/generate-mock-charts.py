...
_chart_names=["application-chart", "assisted-service", "cluster-lifecycle", "cluster-proxy-addon", "console-chart", "policyreport", "discovery-operator", "grc", "management-ingress", "search-prod"]
