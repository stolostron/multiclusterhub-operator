...
shutil.copy(os.path.join(os.path.dirname(os.path.realpath(__file__)), "tmp/dev-tools/bundle-generation/bundles-to-charts.py"), os.path.join(os.path.dirname(os.path.realpath(__file__)), "generate-bundles.py"))
