...
echo "OLD VERSION NO Z $OLD_VERSION_NO_Z"
echo "NEW VERSION NO Z $NEW_VERSION_NO_Z"
echo "OLD_VERSION_CLEANED $OLD_VERSION_CLEANED"
echo "NEW_CLEANED_CLEANED $NEW_CLEANED_CLEANED"
echo "OLD_VERSION_NO_Z_CLEANED $OLD_VERSION_NO_Z_CLEANED"
echo "NEW_VERSION_NO_Z_CLEANED $NEW_VERSION_NO_Z_CLEANED"
