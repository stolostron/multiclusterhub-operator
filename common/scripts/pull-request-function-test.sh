...
./apply.sh
echo "Sleeping for 90 seconds to ensure cluster is accessible after hibernation ..."
sleep 90
set +e
...
make ft-install MOCK=true HUB_IMAGE_REGISTRY='quay.io/open-cluster-management'  VERSION='mock-img'
