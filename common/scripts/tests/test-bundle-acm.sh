...
acmBundleV200="quay.io/open-cluster-management/acm-operator-bundle:2.0.0-SNAPSHOT-2020-07-16-16-16-06"
acmBundleV201="quay.io/open-cluster-management/acm-operator-bundle:2.1.0-SNAPSHOT-2020-07-16-16-44-10"
...
yq w -i build/index-install/upstream/kustomization.yaml 'images[0].newTag' "$Version-index"